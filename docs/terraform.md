...
|------|-------------|------|---------|:--------:|
| access\_points | A list of the access points you would like in your EFS volume | `map(map(map(any)))` | `{}` | no |
...
| Name | Description |
|------|-------------|
| access\_point\_arn | EFS AP ARNs |
| access\_point\_id | EFS AP ids |
| arn | EFS ARN |
